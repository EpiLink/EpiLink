...
class ConfigTestCheck {
    ...
    fun `checkCoherenceWithRuleBook, nothing wrong`() {
        ...
        val result = discordConfig.checkCoherenceWithRulebook(setOf("Here", "AlsoHere"))
    ...
    fun `checkCoherenceWithRuleBook, rule used in Discord server config but not in rulebook`() {
        ...
        val result = discordConfig.checkCoherenceWithRulebook(setOf("Here"))
    ...
    fun `checkCoherenceWithRuleBook, unused rule`() {
        ...
        val result = discordConfig.checkCoherenceWithRulebook(setOf("Here", "KindaLonely", "Thonk"))
