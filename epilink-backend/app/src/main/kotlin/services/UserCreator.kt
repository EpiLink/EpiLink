...
import org.epilink.backend.common.infoOrDebug
...
internal class UserCreatorImpl : UserCreator, KoinComponent {
    ...
    override suspend fun createUser(
        ...
        return when (val adv = isAllowedToCreateAccount(discordId, idpId, email)) {
            is DatabaseAdvisory.Disallowed -> throw UserEndpointException(
...
private inline infix fun DatabaseAdvisory.and(lazyOther: () -> DatabaseAdvisory): DatabaseAdvisory =
    when (this) {
        is DatabaseAdvisory.Disallowed -> this
        DatabaseAdvisory.Allowed -> lazyOther()
    }
